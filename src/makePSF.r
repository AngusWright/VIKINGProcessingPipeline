#
# makePSF2 function generates a gaussian filter kernel for use in SourceExtractor
# using parameters defined in the function call
#
makePSF=function(file='PSFmatrix.dat',dofile=F,res=0.339,targetFWHM=2,pixelgrid=25,norm=T,type='ang',image=F){
